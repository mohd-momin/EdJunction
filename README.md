...
<p align="center">
  <img src="https://res.cloudinary.com/dcvak1h6p/image/upload/v1720680234/edjunction-homepage_vpoylc.png" alt="Main Page">
</p>

## Project Description

EdJunction is a fully functional ed-tech platform that enables users to create, consume,
and rate educational content. The platform is built using the MERN stack, which includes
ReactJS, NodeJS, MongoDB, and ExpressJS.
EdJunction aims to provide:
...
In summary, EdJunction is a versatile and intuitive ed-tech platform that is designed to
...
The EdJunction ed-tech platform consists of three main components: the front end, the
...
<p align="center">
  <img src="https://res.cloudinary.com/dcvak1h6p/image/upload/v1720680817/architecture_qqjp6x.png" alt="Architecture">
</p>

## Front End

The front end of EdJunction has all the necessary pages that an ed-tech platform should
...
EdJunction uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of EdJunction provides a range of features and functionalities, including:
...
1. Cloud-based media management: EdJunction uses Cloudinary, a cloud-based media
...
The back end of EdJunction uses a range of frameworks, libraries, and tools to ensure its
...
The back end of EdJunction uses a range of data models and database schemas to
...
Overall, the back-end of EdJunction is designed to provide a robust and scalable solution
...
The EdJunction platform's API is designed following the REST architectural style. The
...
token.
3. /api/auth/verify-otp (POST) - Verify the OTP sent to the
